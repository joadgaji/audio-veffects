...
//--------------------------------------------------------------
void pRayas::keyPressed  (int key){
	if (key == 's'){
		seqy1 = seqy1 + 5;
	}
	if(key == 'd' && seqy1 > 5){
...
//--------------------------------------------------------------
void pRayas::keyReleased  (int key){

}

//--------------------------------------------------------------
void pRayas::mouseMoved(int x, int y ){
}

//--------------------------------------------------------------
void pRayas::mouseDragged(int x, int y, int button){
}

//--------------------------------------------------------------
void pRayas::mousePressed(int x, int y, int button){
}


//--------------------------------------------------------------
void pRayas::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void pRayas::windowResized(int w, int h){
